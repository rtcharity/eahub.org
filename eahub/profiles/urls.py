...
urlpatterns = [
    ...
    path('edit/email', views.EmailChangeView.as_view(), name='change_email'),
    path('edit/password', views.PasswordChangeView.as_view(), name='change_password'),
    ...
    path('<slug:slug>', views.ProfileView, name='profile'),
]
